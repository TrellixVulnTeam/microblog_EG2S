from flask import render_template, url_for, flash, redirect, request, redirect
...
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash('Congratulations, you are registered to our The Tribal Box platform. Please complete your profile in profile section after login', 'warning')
